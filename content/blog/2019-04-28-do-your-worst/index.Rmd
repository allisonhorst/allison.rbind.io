...
I learned a lot by trying my worst, and created some good reference code in the process. It was surprisingly fun and freeing to be creatively awful. 

From now on, I'll be adding a few early `ggplot2` activities requiring students to do their absolute worst. There's plenty of room at the bottom -- we can learn a lot and have some fun on our way down. 
